...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startFirestoreNotificationService();
        // Cek login status
    ...
    private void startFirestoreNotificationService() {
        if (FirebaseAuth.getInstance().getCurrentUser() != null) {
            Intent serviceIntent = new Intent(this, FirestoreNotificationService.class);

            // Untuk Android 8.0 (Oreo) dan di atasnya
    ...
    private void initializeViews() {
        ...
        adapter = new ReportAdapter(this, reportsList, false);
        listViewReports.setAdapter(adapter);
        swipeRefreshLayout = findViewById(R.id.swipeRefreshLayout);

        // Atur warna loading indicator
    ...
    private void refreshReports() {
        ...
        reportListener = db.collection("reports")
                ...
                .addSnapshotListener((value, error) -> {
                    ...
                    if (error != null) {
                        Log.e(TAG, "Error refreshing reports: ", error);
                        Toast.makeText(MainActivity.this,
                                "Gagal memuat ulang laporan: " + error.getMessage(),
                    ...
                    // Tambahkan pesan jika tidak ada laporan
                ...
                .addSnapshotListener((value, error) -> {
                    if (error != null) {
                        ...
                        if (error.getCode() == FirebaseFirestoreException.Code.UNAVAILABLE ||
                                error.getCode() == FirebaseFirestoreException.Code.DEADLINE_EXCEEDED) {
                            // Kesalahan jaringan
                            showNetworkErrorDialog(error.getMessage());
                            return;
                        }
    ...
    private void deleteReport(Report report, AlertDialog dialog) {
        ...
        if (report.isPaid() != null && report.isPaid()) {
            // Tampilkan dialog bahwa laporan sudah dibayar
            showPaidReportDialog(dialog);
            return;
        }
    ...
    private void showPaidReportDialog(AlertDialog previousDialog) {
        // Tutup dialog konfirmasi sebelumnya
